  ...
  try {
    ...
    while (true) {
      const action = await select({
        ...
        choices: [
          {
            name: `1. Device OTP  ${gray('(OTP_MAIL__key_* + OTP_MAIL_LOGIN_NEW_DEVICE_* + spot:otp-mail*)')}`,
            value: 'device-otp',
          },
...
const DEVICE_OTP_PATTERNS = ['OTP_MAIL__key_*', 'OTP_MAIL_LOGIN_NEW_DEVICE_*', 'spot:otp-mail*']
